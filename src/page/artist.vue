...
export default {
  ...
  methods: {
    ...
    search(){
        ...
        this.$http.post('/music163/weapi/v1/artist/' + this.$route.params.id,
          qs.stringify({
        ...
        this.$http.post('/music163/weapi/artist/introduction',
          qs.stringify({
        ...
        this.$http.post(`/music163/weapi/artist/albums/${this.$route.params.id}`,
          qs.stringify({
